...
; /* Start:"a:4:{s:4:"full";s:67:"/local/templates/main/js/vendor/jquery-2.1.1.min.js?144210975284245";s:6:"source";s:51:"/local/templates/main/js/vendor/jquery-2.1.1.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:54:"/local/templates/main/js/vendor/video.js?1582124123871";s:6:"source";s:40:"/local/templates/main/js/vendor/video.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:57:"/local/templates/main/js/vendor/wow.min.js?14636193668415";s:6:"source";s:42:"/local/templates/main/js/vendor/wow.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:71:"/local/templates/main/js/vendor/jquery.fancybox.pack.js?137116514823135";s:6:"source";s:55:"/local/templates/main/js/vendor/jquery.fancybox.pack.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:60:"/local/templates/main/js/vendor/slick.min.js?146313777740461";s:6:"source";s:44:"/local/templates/main/js/vendor/slick.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
/ __| | |/ __| |/ /  | / __|
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:73:"/local/templates/main/js/vendor/jquery.easydropdown.min.js?13976667667690";s:6:"source";s:58:"/local/templates/main/js/vendor/jquery.easydropdown.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:60:"/local/templates/main/js/vendor/vivus.min.js?148172935611144";s:6:"source";s:44:"/local/templates/main/js/vendor/vivus.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/**
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:67:"/local/templates/main/js/vendor/masonry.pkgd.min.js?147403018823601";s:6:"source";s:51:"/local/templates/main/js/vendor/masonry.pkgd.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
/*!
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:48:"/local/templates/main/js/main.js?162011147244516";s:6:"source";s:32:"/local/templates/main/js/main.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
var servicePriority = {43:1,44:2,46:3,42:4,41:5,45:6};
...
$(document).ready(function() {
    ...
    $('.fancybox').not('[href=#advice]').not('[href=#meeting]').fancybox({
            helpers: {
                overlay: {
                    locked: false
                }
    ...
    if (document.body.clientWidth > 767) {
        $('.fancybox[href=#advice],.fancybox[href=#meeting]').fancybox({
                helpers: {
                    overlay: {
                        locked: false
                    }
        ...
        $('.menu__sub > ul > li').hover(function() {
        ...
        $(document).on('click touchstart', function(e) {
            ...
            hideNotTarget(e, '.h-advice__icon, #advice *, .map__callback, .fancybox[href=#advice],.fancybox[href=#meeting], #meeting *', '.overlay_advice', '#advice,#meeting');
        });
        ...
        $('.h-advice__icon, .fancybox[href=#advice]').on('click',function(e) {
            var $popUp = $('#advice');
            if($popUp.is(':hidden')){
        ...
        $('.fancybox[href=#meeting]').on('click',function(e) {
            var $popUp = $('#meeting');
            if($popUp.is(':hidden')){
                $('.popup:visible').slideUp();
                $popUp.slideDown();
    ...
    $(document).on('click','.map__callback',function(e) {
        if(document.body.clientWidth <= 767)
        {
            var $popUp = $('#advice');
            if($popUp.is(':hidden')){
    ...
    function map() {
        ...
        function initMap() {
            ...
            if ($('#mapGeo').length) {
                ...
                setOffices(map/*,bounds*/);
                setClients(map/*,bounds*/);
        ...
        var offices = [
            ['г. Минск, ул. Сурганова 43, офис 807', 53.926826, 27.589426, 3, '<figure class="map__item"><div class="map__img"><img src="/local/templates/main/images/marker-img.png" alt=""></div><figcaption class="map__info"><div class="map__title">Адрес:</div><div class="map__text">г. Минск, ул. Сурганова 43, офис 807</div><div class="map__metro"><i></i>Академия наук</div><div class="map__title">Контакты:</div><div class="map__number">+375 (17) 348-14-94</div><a href="#advice"class="map__callback">Заказать обратный звонок</a></figcaption></figure>'],
            ['г. Москва, проспект Мира, дом 70, офис 66', 55.78812006894062, 37.63532299999998, 1, 'г. Москва, проспект Мира, дом 70, офис 66'],
            ['г. Санкт-Петербург, ул. Рижская 5, корпус 1, офис 422', 59.92164606419131, 30.415886500000024, 2, 'г. Санкт-Петербург, ул. Рижская 5, корпус 1, офис 422']
        ];

        function setOffices(map/*,bounds*/) {

            var image = {
                url: '/local/templates/main/images/marker.png',
            };
        ...
        var clients = [
			['Tomsk', 56.4832, 85.0071],
			['Irkutsk', 52.2772, 104.355, 26],
			['Samara', 53.1774, 50.1715, 25],
			['Yaroslavl', 57.6114, 39.9051, 24],
			['Tver', 56.8524, 35.9768, 23],
			['Velikiy Novgorod', 58.5147, 31.3299, 22],
			['Soligorsk', 52.789825, 27.535935, 21],
			['Klaipeda', 55.703091, 21.143708, 20],
			['Varshava', 52.230020, 21.011347, 19],
			['Smolensk', 54.790387, 32.050374, 18],
			['Saint Petersburg', 59.936302, 30.317955, 17],
			['Moscow', 55.755704, 37.617152, 16],
			['Vilnius', 54.687153, 25.279540, 15],
			['Jurmala', 56.946809, 23.617071, 14],
			['Riga', 56.949482, 24.106210, 13],
			['Kharkov', 49.993466, 36.230505, 12],
			['Kiev', 50.450077, 30.524129, 11],
			['Grodno', 53.669381, 23.812969, 10],
			['Vitebsk', 55.184962, 30.202587, 9],
			['Mogilev', 53.900522, 30.331176, 8],
			['Gomel', 52.440728, 30.987237, 7],
			['Brest', 52.097748, 23.732828, 6],
			['Minsk', 53.904750, 27.560939, 5],
			['Praga', 50.075686, 14.437710, 4],
            ['Paris', 48.856823, 2.351099, 3],
            ['Bournemouth', 50.719147, -1.880781, 2],
            ['London', 51.507331, -0.127580, 1]
        ];

        function setClients(map/*,bounds*/) {

            var image = {url: '/local/templates/main/images/marker-client.png'};
	...
	$(window).on('load', function () {
		if ($('.projects__wrap').length) {
			...
			$('.sort__btn').on('click', function() {
				...
				if (!$this.hasClass('active')) {
					$('.sort__btn.active').removeClass('active');
					$this.addClass('active');
					$items = $projects.find('.projects__item');
					//remove big class in items
					$items.removeClass('_big').show();
					//filter items by section
					$items.not($this.data('filter')).hide();
					//reset big class for every 9th item
					...
					$items.filter(
						function (index) {
							if(
								...
								$(this).children('img[data-image]').each(function(){this.src = this.getAttribute('data-image')});
								return false;
							}
						}
					).addClass('_big').children('img[data-big-image]').each(function(){
						this.src = this.getAttribute('data-big-image');
					});
					...
					if($this.data('section-id'))
						$('.projects__content .container > .projects__btn:hidden').show();
					else
						$('.projects__content .container > .projects__btn').not(':hidden').hide();
				}
			});

			$('.projects__content .container > .projects__btn .btn').on('click', function() {
				var $this = $(this);
				var $wrap = $this.closest('.projects__content'), data = {};
				var $sortBtns = $wrap.find('.sort__btn');
				var $curSortBtn = null;

				//get load info and last-item info
				data.action = 'getLoadInfo';
				data.itemsCount = $this.data('items-count');
				data.iblockId = $this.data('iblock-id');
				data.lastItems = $this.data('last-items');

				if($sortBtns.length){
					$curSortBtn = $sortBtns.filter('.active');
					if($curSortBtn.length && $curSortBtn.data('section-id') && $curSortBtn.data('section-id')!='all')
						data.sectionId = $curSortBtn.data('section-id');
				}
					...
					success: function(result){
						if(result.success){
							...
							$.ajax({
								...
								success: function(result){
									var $result = $(result);
									$projects.append($result).imagesLoaded(function() {
										$result.show();
										$projects.masonry( 'appended', $result );
									});
								},
								dataType: 'html'
							});

							if(!jQuery.isEmptyObject(result.lastItems)){
								$this.data('last-items',result.lastItems).attr('data-last-items',result.lastItems);
								if($sortBtns.length){
									$sortBtns.each(function(){
										var $btn = $(this);
										if($btn.data('section-id')  && $btn.data('section-id')!='all' && !($btn.data('section-id') in result.lastItems))
											$btn.removeData('section-id').removeAttr('data-section-id');
									});
									if(!$curSortBtn.data('section-id'))
										$this.closest('.projects__btn').not(':hidden').hide();
								}
							}
						}

						if(!result.success || jQuery.isEmptyObject(result.lastItems)){
							if($sortBtns.length)
								$sortBtns.removeData('section-id').removeAttr('data-section-id');
							$this.removeData('last-items').removeAttr('data-last-items').closest('.projects__btn').hide();
						}
					},
					dataType: 'json'
				});
    ...
    if ($('.seo-result').length) {
        $('.tabs__more').on("click", function() {
            var wrap = $(this).prev('.tabs__hidden');
            console.log(wrap);
            if (wrap.hasClass('opened')) {
                wrap.slideUp();
                wrap.removeClass('opened');
                this.innerHTML = 'Показать еще статистику';
            } else {
                wrap.addClass('opened');
                wrap.slideDown();
                this.innerHTML = 'Скрыть дополнительную статистику';
            }
        });
	...
	$('[data-solution-extra]').on('change', function() {
		var $ccd = $('[data-solution-extra]:checked'),
			$price = Number($('[data-solution-price]').data('solution-price'));

		if ($ccd.length > 0) {
			for (var $i = 0; $i < $ccd.length; $i++) {
				var $tmp = Number($($ccd[$i]).data('solution-extra-price'));
		...
		$('[data-full-price]').html($price.toFixed(0).replace(/\d(?=(\d{3})+$)/g, '$& ') + ' <span>RUB</span>');
	});
});

function onClickBtns() {
	$('.tabs__btn-more').on('click', function(e) {
        e.preventDefault();
        $('.hidden-tabs').toggle();
    });
}
...
function calcWidth() {
	var navwidth = 0;
	var morewidth = $('.catalog .tabs__btn-more').outerWidth(true);
	$('.catalog .tabs__pagin > a:not(.tabs__btn-more)').each(function() {
		navwidth += $(this).outerWidth(true);
	});
	var availablespace = $('.catalog .tabs__pagin').outerWidth(true) - morewidth;

	if (navwidth > availablespace) {
		var lastItem = $('.catalog .tabs__pagin > a:not(.tabs__btn-more)').last();
		lastItem.attr('data-width', lastItem.outerWidth(true));
		lastItem.prependTo($('.catalog .tabs__btn-more .hidden-tabs'));
		calcWidth();
	} else {
		var firstMoreElement = $('.catalog .tabs__btn-more .hidden-tabs a').first();
		if (navwidth + firstMoreElement.data('width') < availablespace) {
			firstMoreElement.insertBefore($('.catalog .tabs__btn-more'));
		}
	}

	if ($('.tabs__btn-more .hidden-tabs a').length > 0) {
		$('.tabs__btn-more').css('display', 'inline-block');
	} else {
		$('.tabs__btn-more').css('display', 'none');
	}
}

$(document).on('click','.news__btn [data-ajax-load]',function(e){
    e.preventDefault();
    var $this = $(this);

    var $wrap = $this.closest('.container');
    if($this.data('ajax-load')!=''){
        $.ajax({
            ...
            success:function(data){
                var $data = $(data);
                $wrap.find('.row').append($data.find('.row').children()).after($data.find('.news__btn'));
            }
        });
    }
    $this.closest('.news__btn').remove();
});
...
$(document).on('click','.checkbox',function() {
    $(this).closest('.services').removeClass('err');
    $(this).closest('.services').next(".err-text").remove();
});
$(document).on('change','.checkbox-wrap input[type=checkbox]',function() {
    $(this).closest('.form__block').removeClass('err').find(".err-text").remove();
});
...
$(document).on('submit','form',function(e) {
        ...
        switch (validType) {
            ...
            case "checkbox":
                if ($(this).is(':checked')) {
                    ...
                    er++;
                    $(this).closest('.form__block').addClass('err').append('<span class="err-text">обязательное поле!</span>');
                }
                break;
    ...
    if (er != 0) {
        if (!$form.closest('.popup__form').length) {
            $('html, body').animate({
                scrollTop: $form.find('.err').first().offset().top-$('header').outerHeight()-30
            }, 500);
		}
		
		if ("undefined" != typeof RecaptchaV3Google) {
			RecaptchaV3Google.runSubmit = false;
			RecaptchaV3Google.reset();
		}
		...
		if ($form.attr('name') == 'SIMPLE_FORM_7') {
			...
			var $solutionExtra = $('[data-solution-extra]:checked');
			
			if ($solutionExtra.length > 0) {
				for (var $i = 0; $i < $solutionExtra.length; $i++) {
					var $ccd = $($solutionExtra[$i]),
						$title = $ccd.data('solution-extra'),
						$name = $ccd.data('solution-extra-name'),
						$price = $ccd.data('solution-extra-price-format');
			...
			value += 'Итог: ' + $($('[data-full-price]')[0]).text().trim().replace(/\s{2,}/g, ' ');
			
			if (!!value) {
				$form.find('textarea.addfield').text(value.replace(/(<([^>]+)>)/ig,""));
			}
		}
	}
});
...
$(document).on('change','.form__services .services__item input:checkbox',function(){
    var priority=false, curLinkProp=false, $this = $(this);
    var $checkboxes = $(this).closest('.form__services').find(':checkbox:checked'),
        $serviceLinkedProps = $this.closest('form').find('.form__block[class*="service_val_"]');
    if($checkboxes.length){
        $.each($checkboxes, function(key,el) {
            if(priority===false || priority<servicePriority[el.value]){
                priority = servicePriority[el.value];
                curLinkProp = el.value;
            }
        });
    }
    if(curLinkProp===false){
        $serviceLinkedProps.not('.service_val_empty').hide().find('select').val('').removeAttr('data-valid').easyDropDown('destroy').easyDropDown();
        $('.service_val_empty').show().find('select').attr('data-valid', 'select');
    }else{
        $serviceLinkedProps.not('.service_val_'+curLinkProp).hide().find('select').val('').removeAttr('data-valid').easyDropDown('destroy').easyDropDown();
        $('.service_val_'+curLinkProp).show().find('select').attr('data-valid', 'select');
    }
});


//handle select change
$(document).on('change',".select_site select", function() {
    if ($(this).find('option:selected').text() === "Да")
        $('.form__block_site').slideDown().find('select').attr("data-valid", "select");
    else
        $('.form__block_site').slideUp().find('select').removeAttr("data-valid", "select");
});
$(document).on('change',".select_country select", function() {
    if ($(this).find('option:selected').text() === "Другая страна")
        $('.form__block_country').slideDown();
    else
        $('.form__block_country').slideUp();
});
$(document).on('change',".select_hear select", function() {
...
//project hover
$(document).on('mouseenter','.client__item,.portfolio__item,.projects__item',function(){
    $(this).addClass('onHover')
});
$(document).on('mouseleave','.client__item,.portfolio__item,.projects__item',function(){
...
BX.addCustomEvent('onAjaxSuccess', function(data){
    ...
    if(typeof Recaptchafree !== 'undefined')
        Recaptchafree.reset();
    if(typeof RecaptchaV3Google !== 'undefined')
        RecaptchaV3Google.reset();
});
...
$(document).ready(function(){
    ...
    function init() {
        ...
        var marketSetting  = {
			...
			iconImageHref: '/local/templates/main/images/marker.png',
			iconImageSize: [36, 52],
			iconImageOffset: [-18, -52]
		}        
        var marketSetting2 = {
			iconLayout: 'default#image',
			iconImageHref: '/local/templates/main/images/marker-client.png',
			iconImageSize: [18, 26],
        ...
        var markers = [
            {
                name: 'Беларусь,  г. Минск',
                point: [53.904575, 27.561642],
                content: '<figure class="map__item"><div class="map__img"><img src="/local/templates/main/images/marker-img.jpg" alt=""></div><figcaption class="map__info"><div class="map__title">Адрес:</div><div class="map__text">г. Минск, ул. Интернациональная 36, офис 505</div><div class="map__metro"><i></i>Октябрьская</div><div class="map__title">Контакты:</div><div class="map__number">+375 (17) 348-14-94</div><a href="#advice" class="map__callback">Заказать обратный звонок</a></figcaption></figure>',
                type: 'office'
            },
            {
                name: 'Россия, г.Москва',
                point: [55.7881259, 37.6353168],
                content: '<figure class="map__item"><div class="map__img"><img src="/local/templates/main/images/img_m-3.png" alt=""></div><figcaption class="map__info"><div class="map__title">Адрес:</div><div class="map__text">г. Москва, проспект Мира, дом 70, офис 66</div><div class="map__metro"><i></i>Рижская</div><div class="map__title">Контакты:</div><div class="map__number"><span class="roistat-phone1">+7 (499) 113-50-35</span></div><a href="#advice" class="map__callback">Заказать обратный звонок</a></figcaption></figure>',
                type: 'office'
            },            
            {
                name: 'Россия, г. Санкт-Петербург',
                point: [59.9216460,30.4158865],
                content: 'г. Санкт-Петербург, Рижская улица, 5, корпус 1, офис 422',
                type: 'office'
            }
        ]
        ...
        var clients = [
            {
                name: 'Soligorsk',
                point: [52.789825, 27.535935],
                content: null,
                type: 'client'
            },
            {
                name: 'Klaipeda',
                point: [55.703091, 21.143708],
                content: null,
                type: 'client'
            },
            {
                name: 'Varshava',
                point: [52.230020, 21.011347],
                content: null,
                type: 'client'
            },
            {
                name: 'Smolensk',
                point: [54.790387, 32.050374],
                content: null,
                type: 'client'
            },
            {
                name: 'Saint petersburg',
                point: [59.936302, 30.317955],
                content: null,
                type: 'client'
            },
            {
                name: 'Moscow',
                point: [55.755704, 37.617152],
                content: null,
                type: 'client'
            },
            {
                name: 'Vilnius',
                point: [54.687153, 25.279540],
                content: null,
                type: 'client'
            },
            {
                name: 'Jurmala',
                point: [56.946809, 23.617071],
                content: null,
                type: 'client'
            },
                        {
                name: 'Riga',
                point: [56.949482, 24.106210],
                content: null,
                type: 'client'
            },
                        {
                name: 'Kharkov',
                point: [49.993466, 36.230505],
                content: null,
                type: 'client'
            },
                        {
                name: 'Kiev',
                point: [50.450077, 30.524129],
                content: null,
                type: 'client'
            },
                        {
                name: 'Grodno',
                point: [53.669381, 23.812969],
                content: null,
                type: 'client'
            },
            {
                name: 'Vitebsk',
                point: [55.184962, 30.202587],
                content: null,
                type: 'client'
            },
            {
                name: 'Mogilev',
                point: [53.900522, 30.331176],
                content: null,
                type: 'client'
            },
            {
                name: 'Gomel',
                point: [52.440728, 30.987237],
                content: null,
                type: 'client'
            },
            {
                name: 'Brest',
                point: [52.097748, 23.732828],
                content: null,
                type: 'client'
            },                        
            {
                name: 'Minsk',
                point: [53.904750, 27.560939],
                content: null,
                type: 'client'
            },
            {
                name: 'Praga',
                point: [50.075686, 14.437710],
                content: null,
                type: 'client'
            },                        
            {
                name: 'Paris',
                point: [48.856823, 2.351099],
                content: null,
                type: 'client'
            },
                        {
                name: 'Bournemouth',
                point: [50.719147, -1.880781],
                content: null,
                type: 'client'
            },                        
            {
                name: 'London',
                point: [51.507331, -0.127580],
                content: null,
                type: 'client'
            },
        ...
        if ($('#mapContactsYandex').length) {
            var myMap = new ymaps.Map('mapContactsYandex', { // id map
                suppressMapOpenBlock: true,
                center: [56.800878, 30.1293792],
                zoom: 5,
            });
        }

        if ($('#mapYandex').length) {
            var myMap = new ymaps.Map('mapYandex', { // id map
                suppressMapOpenBlock: true,
                center: [56.800878, 30.1293792],
                zoom: 5,
            });
		...
		if (myMap) {
			markers.forEach(function(item){
				item.type == 'client' ? totalSettings = marketSetting2  : totalSettings = marketSetting;
        ...
        if ($('#mapGeoYandex').length) {
            var myMap2 = new ymaps.Map('mapGeoYandex', { // id map
                suppressMapOpenBlock: true,
                center: [56.800878, 30.1293792],
                zoom: 5,
            });

            markers = markers.concat(clients);
            ...
            myMap2.geoObjects.events.add('click', function(e) {
                var targetObject2 = e.get('target');

                if (targetObject2.geometry.getType() === 'Point') {
                    myMap2.setCenter(targetObject2.geometry.getCoordinates(), FOCUS_ZOOM, {
                        checkZoomRange: false
                    });
                }
            });
	...
	if ($(window).width() < 768){
        $('.menu__sub').each(function () {
            $(this).parent('li').addClass('menu__sub-container')
        })
    }
})
/* End */
;; /* /local/templates/main/js/vendor/jquery-2.1.1.min.js?144210975284245*/
; /* /local/templates/main/js/vendor/video.js?1582124123871*/
; /* /local/templates/main/js/vendor/wow.min.js?14636193668415*/
; /* /local/templates/main/js/vendor/jquery.fancybox.pack.js?137116514823135*/
; /* /local/templates/main/js/vendor/slick.min.js?146313777740461*/
; /* /local/templates/main/js/vendor/jquery.easydropdown.min.js?13976667667690*/
; /* /local/templates/main/js/vendor/vivus.min.js?148172935611144*/
; /* /local/templates/main/js/vendor/imagesloaded.pkgd.min.js?14740301945441*/
; /* /local/templates/main/js/vendor/masonry.pkgd.min.js?147403018823601*/
; /* /local/templates/main/js/main.js?162011147244516*/
